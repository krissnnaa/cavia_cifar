...
def parse_args():
    ...
    parser.add_argument('--tasks_per_metaupdate', type=int, default=8, help='number of tasks in each batch per meta-update')
    ...
    parser.add_argument('--imsize', type=int, default=32, help='downscale images to this size')
    ...
    parser.add_argument('--data_path', type=str, default='./data/cifar/', help='folder which contains image data')
